// Outputs for the "CIAM-Passwordless-Protect-Account-Recovery-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Account-Registration-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Agreement(ToS)-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Change-Password-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Device-Authentication-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Device-Registration-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Magic-Link-Authentication-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Registration-Authentication-Account-Recovery-Main Flow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Threat-Detection-Subflow" flow.
...
// Outputs for the "CIAM-Passwordless-Protect-Verify-Email-Subflow" flow.
...
// Outputs for the "OOTB - Basic Profile Management" flow.
...
// Outputs for the "OOTB - Change Password - Subflow - 1" flow.
...
// Outputs for the "OOTB - Device Management - Main Flow" flow.
...
// Outputs for the "OOTB - Device Registration - Subflow - 1" flow.
...
// Outputs for the "OOTB - Password Reset - Main Flow" flow.
