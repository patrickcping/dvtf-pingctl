...
resource "davinci_flow" "ciam_passwordless_protect_account_recovery_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_account_recovery_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_account_registration_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_account_registration_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_agreement_tos_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_agreement_tos_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_change_password_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_change_password_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_device_authentication_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_device_authentication_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_device_registration_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_device_registration_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_magic_link_authentication_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_magic_link_authentication_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_registration_authentication_account_recovery_main_flow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_registration_authentication_account_recovery_main_flow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_threat_detection_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_threat_detection_subflow.json")
...
resource "davinci_flow" "ciam_passwordless_protect_verify_email_subflow" {
  ...
  flow_json = file("assets/flows/ciam_passwordless_protect_verify_email_subflow.json")
...
resource "davinci_flow" "ootb_basic_profile_management" {
  ...
  flow_json = file("assets/flows/ootb_basic_profile_management.json")
...
resource "davinci_flow" "ootb_change_password_subflow_1" {
  ...
  flow_json = file("assets/flows/ootb_change_password_subflow_1.json")
...
resource "davinci_flow" "ootb_device_management_main_flow" {
  ...
  flow_json = file("assets/flows/ootb_device_management_main_flow.json")
...
resource "davinci_flow" "ootb_device_registration_subflow_1" {
  ...
  flow_json = file("assets/flows/ootb_device_registration_subflow_1.json")
...
resource "davinci_flow" "ootb_password_reset_main_flow" {
  ...
  flow_json = file("assets/flows/ootb_password_reset_main_flow.json")
